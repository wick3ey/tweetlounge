      ...
      <div className="page-container py-12 max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row gap-8 items-center">
          <div className="md:w-1/2">
            <h1 className="text-3xl font-bold text-twitter-blue mb-3">Börja din resa</h1>
            <p className="text-gray-600 mb-4">
              Gå med i TweetLounge idag för att dela dina tankar, ansluta dig till 
              samtal och vara en del av en global gemenskap.
            </p>
